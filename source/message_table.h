...
#define SPEED_VALUE_PERIOD 		4
#define TORQUE_VALUE_LENGTH 	3
#define TORQUE_VALUE_PERIOD 	4
#define MOTOR_STATUS_LENGTH 	5
#define MOTOR_STATUS_PERIOD 	20
